 ...
 *                 &lt;sequence>
 *                   &lt;element name="funcType" type="{http://www.example.org/nffgInfo}functionalTypeType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends ReachabilityPolicyType
{
    ...
    public static class TraversedFunctionalTypes {
        ...
        protected List<FunctionalTypeType> funcType;
         ...
         * 
         */
        public List<FunctionalTypeType> getFuncType() {
            if (funcType == null) {
                funcType = new ArrayList<FunctionalTypeType>();
            }
